...
2. **Generate for Video**: Adds camera movement and motion instructions
...
| **Video Prompt** | Motion & Camera Prompt | Enhanced prompt with camera movement<br>- Generated by "Generate for Video" button<br>- Includes camera work (pan, zoom, dolly, etc.)<br>- ✨/↶↷ buttons for LLM and undo/redo |
...
| Generate for Video | Button | Add camera movement to all prompts |
