...
class VideoButton(QPushButton):
    ...
    refine_requested = Signal()  # Emitted when user wants to conversationally refine the clip (Gemini Omni only)
    ...
    def __init__(self, parent=None):
        ...
        self.is_omni = False  # True when the clip was generated by Gemini Omni (refinable)
    ...
    def set_video_state(
        ...
        Args:
            ...
            is_omni: True if the clip was generated by Gemini Omni (enables Refine)
        """
    ...
    def contextMenuEvent(self, event):
        ...
        if self.has_video():
            ...
            # Add Refine option for Gemini Omni clips (conversational editing)
            if self.is_omni:
                refine_action = QAction("✨ Refine (Omni)...", self)
                refine_action.setToolTip(
                    "Conversationally refine this clip with Gemini Omni.\n"
                    "Describe a change (e.g. \"make it night\") and Omni edits\n"
                    "the existing clip, chaining from the previous generation."
                )
                refine_action.triggered.connect(self.refine_requested.emit)
